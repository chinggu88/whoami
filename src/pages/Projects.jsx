    ...
    <section>
      ...
      <div class="side-projects">
        <div class="side-card">
          ...
          <p>나의 사고 흐름을 <strong>크론(clone)</strong>해 앱을 만드는 AI 에이전트. 단순 코드 생성이 아니라 <strong>내 손에 익은 코드 규칙·네이밍·폴더 구조</strong>를 그대로 따르는 것이 핵심. 새 프로젝트마다 같은 결의 <strong>일관된 보일러플레이트</strong>를 자동 생성해, <strong>눈에 익은 코드</strong> 위에서 바로 작업하고 <strong>기존 스타일을 유지한 채 유지보수에도 신속히 대응</strong>할 수 있도록 만드는 실험.</p>
          <div class="side-actions">
            <a href="https://github.com/chinggu88/teams_agent_test" target="_blank" rel="noopener noreferrer" class="side-action">
        ...
        <div class="side-card">
          <span class="status">◆ Experiment · 사내프로젝트</span>
        ...
        <div class="side-card has-icon-corner">
          <div class="app-icon app-icon-corner" aria-label="언넝 앱 아이콘">
            <img src="unnung.png" alt="언넝 앱 아이콘"/>
          </div>
          <span class="status">◆ Released · AOS &amp; iOS</span>
          <h4 class="serif">언넝 (unnung)</h4>
          <p><strong>계좌이체를 한 번에</strong> — 사진으로 계좌번호를 자동 추출·저장하고, 현재 위치 기준으로 자주 쓰는 계좌를 위로 정렬, 탭 한 번에 번호 복사와 해당 은행 앱 자동 이동까지 이어지는 Flutter 앱. <strong>Gemini AI + 위치 기반</strong> 로직으로 동작하며, 약 <strong>7개월간</strong> Firebase·Supabase·Isar로 백엔드와 로컬DB를 함께 다루며 출시까지 완주. 개인정보처리방침·이용약관 호스팅, 빌드 13회 — 사이드 프로젝트도 <strong>운영 가능한 수준</strong>까지 마무리 지은 작업.</p>
          <div class="side-actions">
            <a href="https://github.com/chinggu88/unnung" target="_blank" rel="noopener noreferrer" class="side-action">
              <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden="true">
                <path d="M12 .5C5.65.5.5 5.65.5 12c0 5.08 3.29 9.39 7.86 10.91.58.1.79-.25.79-.56 0-.28-.01-1.02-.02-2-3.2.69-3.87-1.54-3.87-1.54-.52-1.33-1.28-1.69-1.28-1.69-1.05-.72.08-.7.08-.7 1.16.08 1.77 1.19 1.77 1.19 1.03 1.77 2.7 1.26 3.36.96.1-.75.4-1.26.73-1.55-2.55-.29-5.24-1.28-5.24-5.69 0-1.26.45-2.29 1.18-3.1-.12-.29-.51-1.46.11-3.05 0 0 .97-.31 3.18 1.18a11.04 11.04 0 0 1 5.79 0c2.21-1.49 3.18-1.18 3.18-1.18.62 1.59.23 2.76.11 3.05.74.81 1.18 1.84 1.18 3.1 0 4.42-2.69 5.39-5.25 5.68.41.36.78 1.05.78 2.12 0 1.53-.01 2.76-.01 3.13 0 .31.21.67.8.56C20.21 21.39 23.5 17.08 23.5 12 23.5 5.65 18.35.5 12 .5z"/>
              </svg>
              <span>View on GitHub</span>
            </a>
            <a href="https://play.google.com/store/apps/details?id=com.iksun.unnung" target="_blank" rel="noopener noreferrer" class="side-action">
              <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden="true">
                <path d="M3.6 1.7c-.3.3-.5.8-.5 1.4v17.8c0 .6.2 1.1.5 1.4l9.7-10.6L3.6 1.7zm11.2 9.4l2.6-2.8L5.4 1.4c-.3-.2-.6-.2-.9-.1l10.3 9.8zM4.5 22.7c.3.1.6.1.9-.1l12-6.9-2.6-2.8-10.3 9.8zm15.7-10.6l-3 1.7 2.8 3 3-1.7c.9-.5.9-1.9.1-2.4l-2.9-1.6 2.9-1.6c.8-.5.8-1.9-.1-2.4l-3-1.7-2.8 3 3 1.7z"/>
              </svg>
              <span>Google Play</span>
            </a>
            <a href="https://apps.apple.com/us/app/unnung/id6739683415" target="_blank" rel="noopener noreferrer" class="side-action">
              <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden="true">
                <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09zM12 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
              </svg>
              <span>App Store</span>
